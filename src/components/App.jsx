...
const App = () => {
    ...
    useEffect(() => {
        ...
        async function getImages() {
            ...
            try {
                ...
                const errorMessage = error.data?.errors.join(", ") || error.message;
    ...
    return (
        <div className={css.container}>
            ...
            <ImageModal image={modalImage} isOpen={modalIsOpen} closeModal={closeModal} />
            {totalPages > 0 && page < totalPages && <LoadMoreBtn onClick={handleLoadMore} />}
